            ...
            <tbody>
              {students.map((student) => (
                <tr key={student.studentId}>
                  ...
                  <td>
                    <button className="grade-bt" onClick={() => fetchEnrolledCourses(student.studentId)}>
                      Get Courses
                    </button>
                  </td>
                </tr>
...
<div class="full">
      ...
      {Object.values(EnrolledCourses).map((course) => (
        <table className="grade-table1" key={course.enrollmentId}>
        <tbody>
          <tr class="grade-row">
            <td class="grade-d">{course.courseId}</td>
            <td class="grade-d">{course.courseName}</td>
            <td class="grade-d">{course.instructor}</td>
            <td>
              <button className="grade-bt" onClick={() => openGradingPopup(course.courseId)}>
                Grade
              </button>
            </td>
          </tr>
      ...
      {isGradingPopupVisible ? (
        <div className="grading-popup">
          ...
          <button className="buttons" onClick={saveGradingData}>
            Submit
          </button>
          <button className="buttons" onClick={closeGradingPopup}>
            Cancel
          </button>
        </div>
      ) : null}
