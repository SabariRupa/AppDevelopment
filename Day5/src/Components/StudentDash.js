    ...
    <div className="sidebar-container">
      ...
      <img class ="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9hg7-zcRhhTCaa9QppL_6b4aYJm0CL-oU4hem187kCA&s"/>
        ...
        <div id="contents">
            ...
            style={{ backgroundColor: activeMenuItem === 'stu' ? 'aliceblue' : 'transparent',}}> My Profile</MenuItem>
            ...
            style={{ backgroundColor: activeMenuItem === 'act' ? 'aliceblue' : 'transparent', }}> Activities</MenuItem>
            <MenuItem  onClick={() => handleMenuItemClick('ins')}
            style={{ backgroundColor: activeMenuItem === 'ins' ? 'aliceblue' : 'transparent',}}>Contact Instructors </MenuItem>
          </div>
