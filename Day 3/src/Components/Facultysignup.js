...
function Facultysignup() {
  ...
  const validate=(e)=>{
    e.preventDefault();
    if(Email.length===0||Pass.length===0||conPass.length===0)
    {
  ...
  return (
    ...
    <section>
    <div class="imgBx">
        <img src="https://img.rawpixel.com/s3fs-private/rawpixel_images/website_content/rm373batch3-64-s88-ko4094ug.jpg?w=800&dpr=1&fit=default&crop=default&q=65&vib=3&con=3&usm=15&bg=F4F4F3&ixlib=js-2.2.1&s=c80a3a28be3a1fb0e36f716e8881f855"/>
    </div>
    <div class="contentBx">
        <div class="formBx">
